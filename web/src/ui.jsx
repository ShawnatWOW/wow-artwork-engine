...
// Preview an artwork at its true aspect ratio: a still renders as an image, a
// motion piece as an autoplaying video.
...
export function Actions({ selected, status, busy, stage, onSelect, onApprove, onReject }) {
  const btn = 'inline-flex items-center gap-1 rounded px-2 py-1 text-[11px] font-medium transition disabled:opacity-40';
  const approveLabel = stage === 'still' ? 'Approve style' : 'Approve';
  return (
